...
//        Stream<Integer> sortedAgeStream = customerList.stream().sorted(Comparator.comparing(a->a.getAge())).map(a->a.getAge());
        Stream<Integer> sortedAgeStream = customerList.stream().sorted((a,b)->a.getAge()-b.getAge()).map(a->a.getAge());
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = Comparator.comparing(Integer::intValue);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((c1,c2) ->c2.getBudget()-c1.getBudget()).limit(3).map(Customer::getName);
